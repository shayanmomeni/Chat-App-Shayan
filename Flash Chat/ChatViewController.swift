...
class ChatViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        let tapGuster = UITapGestureRecognizer(target: self, action: #selector(tableViewTapped))
        messageTableView.addGestureRecognizer(tapGuster)
        ...
        // Pass messages from database to the tableview
        retrieveMessages()
        
        // Remove the line of each cell ,that make sepreate each cell
